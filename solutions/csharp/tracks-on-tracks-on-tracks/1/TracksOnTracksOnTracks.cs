...
public static class Languages
{
    ...
    public static bool IsExciting(List<string> languages)
    {
        ...
        if (languages.First() == "C#")
            return true;
        if (languages[1] == "C#" && (languages.Count is >= 2 and <= 3))
            return true;
        else
            return false;
    }
    public static List<string> RemoveLanguage(List<string> languages, string language) => languages.Where(y => y != language).ToList();
